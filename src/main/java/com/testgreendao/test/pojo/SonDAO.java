 ...
 */
public class SonDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory.getLogger(SonDAO.class);
	// property constants
	...
	public static SonDAO getFromApplicationContext(ApplicationContext ctx) {
		return (SonDAO) ctx.getBean("SonDAO");
	}
}